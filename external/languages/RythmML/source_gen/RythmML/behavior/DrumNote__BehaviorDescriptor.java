...
public final class DrumNote__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static void generate_id5aWFjTLUNx6(@NotNull SNode __thisNode__, Track track, int bar, int beatPerBar, int resolution, int velocity) {
    long tick = SongUtils.toTick(bar, SPropertyOperations.getInteger(SLinkOperations.getTarget(__thisNode__, LINKS.position$ezGg), PROPS.beat$t$AP), Double.parseDouble(SPropertyOperations.getString(SLinkOperations.getTarget(__thisNode__, LINKS.position$ezGg), PROPS.division$v_0r)), beatPerBar, resolution);

    SongUtils.addHit(track, Integer.parseInt(SPropertyOperations.getEnum(__thisNode__, PROPS.drum$Mb34).getName()), tick, velocity, 1);
  }
  ...
  private static final class PROPS {
    ...
    /*package*/ static final SProperty division$v_0r = MetaAdapterFactory.getProperty(0xf1ebcfd5fd1b4a1dL, 0xa2ad03091ad47f30L, 0x65912afefd81ca6dL, 0x65912afefd8cecf4L, "division");
